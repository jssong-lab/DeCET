...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--file_list", type=str,
                        help=("List of files to be read into the tensor.         \n"
                              "Should be tab deliminated with the first entry    \n"
                              "being the name of the file followed by an optional\n"
                              "control file (or . if no control is available),   \n"
                              "followed by the tensor index for this file. Required"))
    ...
    parser.add_argument("-g", "--genome", type=str, choices=["hg19","hg19X","hg19S","hg38","mm10","custom"], default="hg19",
                        help=("Specify a genome to use. This specifies the chromosomes to be  \n"
                              ...
                              "corresponding lengths of a genome. Each should specify a       \n"
                              "chromosome name that will appear in the corresponding bed files\n"
                              "and the length of this chromosome separated by a tab,          \n"
                              "e.g. chr1	249250621"))
    ...
    parser.add_argument("-p", "--processors", type=int, default=1,
                        help=("Number of processors to use. Parallelization allows multiple   \n"
                              ...
                              "factors are also calculated in parrallel. Default 1"))
